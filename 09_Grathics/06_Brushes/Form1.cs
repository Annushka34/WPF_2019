...
namespace _06_Brushes
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            Graphics g = CreateGraphics();
            Rectangle r = new Rectangle(rand.Next(150, 500), rand.Next(5, 200), 150, 150);
            TextureBrush tBrush = new TextureBrush(Image.FromFile(Directory.GetCurrentDirectory() + "\\grass.jpeg"));
            g.FillPie(tBrush, r, 90f, 90f);
            g.Dispose();
        }
